...
class View(Resource):
    ...
    @autoDescribeRoute(
        ...
        .param(
            "text", "Pass this to perform a full text search for views", required=False
        )
        .param(
            "exact",
    ...
    @autoDescribeRoute(
        ...
        .param("columns", "The number of columns in the view.", paramType="formData")
        .param("step", "Time step to start at.")
        .jsonParam(
            "items",
            "The object describing the items shown and their position in the grid.",
            paramType="formData",
            requireObject=True,
        )
        .jsonParam(
            "meta",
            "An object describing meta data to associate with the view.",
            paramType="formData",
            requireObject=True,
            required=False,
        )
        .param(
            "public",
            "Whether this view should be available to everyone.",
            required=False,
            dataType="boolean",
            default=True,
            paramType="formData",
        ...
        .errorResponse(
            "A parameter was invalid, or the specified name already exists in the system."
        )
    )
