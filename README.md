...
![eSimMon Dashboard](devops/images/esimmon.jpg)
...
generate/convert data extracts is also in progress. 

Requirements
------------

This following packages needs to be installed in order to bring up the eSimMon stack:
